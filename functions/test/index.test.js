...
console.log('Testing transcodeVideo');
const transcode_video_wrapped = test.wrap(myfunctions.transcodeVideo);
console.log(transcode_video_wrapped(
    {
        name:'video/HK0fpmQI7WOGUDwdmVpPffis7hY2/dzXZ7bZe7Km55R7Aoqzf/qxLkbGSsY6jsKJeX6O1A/beauty_video_4.mov',
        bucket:'gs://influencer-272204.appspot.com/',
